import { H1MarkdownRenderPlugin } from '$lib/client/ui-tools/renderer/markdown/h1-md-renderer-plugin';
import { describe, expect, it } from 'vitest';

describe('h1-md-renderer', () => {
  describe('H1MarkdownRenderPlugin', () => {
    describe('when instantiated', () => {
      it('should return an object', () => {
        const h1 = new H1MarkdownRenderPlugin();
    ...
    describe('render()', () => {
      ...
      it('should render given markdowns', () => {
        const markdowns = [
          {
            md: '# foo',
            rendered: '<h1 class="first-letter:capitalize font-bold text-3xl">foo</h1>'
          },
          {
            md: '# foo bar',
            rendered: '<h1 class="first-letter:capitalize font-bold text-3xl">foo bar</h1>'
          }
        ];
